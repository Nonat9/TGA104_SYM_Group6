...
create table store(
    ...
    storePhoto longblob comment '賣場圖片',
...
INSERT INTO store (memberID,storeName,storePhoto,storeDelBankCode,storeBankAccount,storeAddress,phoneNumber,createDate,updateDate,taxID,storeAuditStatus) 
VALUES('1','與決賣場',null,'Q123456','W123456','西門町','123456789',now(),now(),'OX123456',0);
INSERT INTO store (memberID,storeName,storePhoto,storeDelBankCode,storeBankAccount,storeAddress,phoneNumber,createDate,updateDate,taxID,storeAuditStatus) 
VALUES('2','土豪賣場',null,'A123456','S123456','內湖','234567891',now(),now(),'XO123456',0);
INSERT INTO store (memberID,storeName,storePhoto,storeDelBankCode,storeBankAccount,storeAddress,phoneNumber,createDate,updateDate,taxID,storeAuditStatus) 
VALUES('3','企鵝賣場',null,'Z123456','X123456','中和','34567891',now(),now(),'KO123456',0);
...
administratorID int not null comment '管理員編號',
groupBuyID int comment "團購編號ID",
adTitle varchar(25) comment "廣告標題",
adType varchar(25) comment "廣告類別",
